...
export const seedTestData = onCall(
  ...
  async (request) => {
    ...
    const seedMembers = [
      { id: "test-bak-jh", name: "박정호", belt: "BROWN", weightClass: "HEAVY", avatarId: "m_heavy" },
      { id: "test-choi-ms", name: "최민서", belt: "BLACK", weightClass: "MIDDLE", avatarId: "m_middle" },
      { id: "test-kim-sh", name: "김상혁", belt: "PURPLE", weightClass: "WELTER", avatarId: "m_welter" },
      { id: "test-han-dy", name: "한도윤", belt: "BLUE", weightClass: "LIGHT", avatarId: "m_light" },
      { id: "test-shin-yr", name: "신예린", belt: "WHITE", weightClass: "FEATHER", avatarId: "f_feather" },
      { id: "test-jang-tj", name: "장태준", belt: "BLACK", weightClass: "MIDDLE", avatarId: "m_middle" },
    ];
