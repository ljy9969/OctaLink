...
// 2026-09-22: 대진표(관내 토너먼트) vs 교류전(타 체육관 스파링) 혼동 수정 — support 초안 → CEO 검토 승인,
//             두 카드로 분리. (지어낸 정책 링크는 결정적 제거.)
private val FAQ_ITEMS = listOf(
    ...
    FaqItem(
        "대진표(관내 토너먼트)는 어떻게 참여하나요?",
        "대진표는 같은 체육관 회원끼리 겨루는 관내 토너먼트입니다. 대진 추첨은 관장·운영진이 진행하며, 회원님은 홈 화면의 '이번 주 대진표' 카드를 눌러 대진과 결과를 확인하실 수 있습니다. 지난 토너먼트는 대진표 화면의 히스토리에서 볼 수 있습니다.",
    ),
    FaqItem(
        "교류전(다른 체육관 스파링)은 어떻게 참여하나요?",
        "교류전은 다른 체육관 관원에게 직접 스파링을 신청해 전적을 쌓는 기능으로, 관내 대진표와는 다릅니다. 홈 화면의 '⚔️ 교류전' 카드를 누른 뒤 다른 체육관 명단에서 상대를 골라 '신청'하시면 됩니다. 신청 후 양측 운영진의 승인을 거치면 일정이 확정되고, 관련 알림을 받으실 수 있습니다.",
    ),
    FaqItem(
        "수업 시작 전에 알림을 받고 싶어요.",
    ...
    FaqItem(
        "알림이 오지 않거나 늦게 와요.",
        "수업 리마인더가 오지 않으면 순서대로 확인해 주세요. ① 설정 > 알림 설정에서 '수업 리마인더'가 켜져 있고 앱 알림 권한이 허용됐는지 ② '알람 및 리마인더' 권한 허용 ③ 배터리 최적화 제외(삼성 기기는 배터리 사용을 '제한 없음'으로).",
    ),
    FaqItem(
        "로그아웃하면 기록이 사라지나요?",
